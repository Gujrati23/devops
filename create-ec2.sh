...
check_awscli() {
    if ! command -v aws &> /dev/null; then
        echo "AWS CLI is not installed. Please install it first time." >&2
       return 1    
    fi
}
...
main() {
    ...
    SUBNET_ID="subnet-0e6d568c15f48b41b"
    SECURITY_GROUP_IDS="sg-058698f2cc7e79353"  # Add your security group IDs separated by space
